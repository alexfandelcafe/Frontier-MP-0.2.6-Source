...
// Generated Thu, 24 Sep 2026 10:16:19 GMT
...
namespace CORE
{
	...
	// PC only
	static Any IS_BUTTON_PRESSED_ANY_CONTROLLER(Any p0) { return invoke<Any>(0x4586516D, p0); } // 0x4586516D
	// PC only
	static Any IS_ANY_CONTROLLER_BUTTON_DOWN(Any p0) { return invoke<Any>(0x7E452200, p0); } // 0x7E452200
	...
	// Mobile only
	static BOOL IS_MOBILE() { return invoke<BOOL>(0x4A012B39); } // 0x4A012B39
	...
	// Mobile only
	static BOOL IS_USING_TOUCH_INTERFACE() { return invoke<BOOL>(0x282E55F5); } // 0x282E55F5
	// Mobile only
	static void SHOW_TOUCH_JOYSTICK(BOOL toggle) { invoke<void>(0x141E1F68, toggle); } // 0x141E1F68
	// Mobile only
	static float GET_TOUCH_RADIAL_DELTA() { return invoke<float>(0x3F416C75); } // 0x3F416C75
...
namespace PC
{
	...
	static Any SET_BLACKWATERSURVIVOR(Any p0) { return invoke<Any>(0x9F832205, p0); } // 0x9F832205
	// PC only, used by event_treasurehunter_intro.wsc
	static Any SET_TAKING_TREASUREMAP(Any p0) { return invoke<Any>(0xF413FDB2, p0); } // 0xF413FDB2
	// PC only, used by event_law_repsonse_*.wsc
	static Any SET_BRIBING_LAW_ENFORCEMENT(Any p0) { return invoke<Any>(0x63D3AAFC, p0); } // 0x63D3AAFC
	// PC only, used by *_z.wsc
	static Any SET_BOSS_ZOMBIE_SPAWNING(Any p0) { return invoke<Any>(0x3B93B981, p0); } // 0x3B93B981
	...
	static Any SET_COLLECTING_BOUNTY_PAY(Any p0) { return invoke<Any>(0xEB0F9F0C, p0); } // 0xEB0F9F0C
	...
	static Any SET_MERCHANT05_RACE_FINISHED(Any p0) { return invoke<Any>(0x02859CE6, p0); } // 0x02859CE6
	...
	static Any SET_STAGECOACH_TUTORIAL(Any p0) { return invoke<Any>(0x9CED1C7E, p0); } // 0x9CED1C7E
	// PC only, used by gun01.wsc
	static Any SET_GUN01_HOSTAGE_SCENE(Any p0) { return invoke<Any>(0xD9DDA7E2, p0); } // 0xD9DDA7E2
